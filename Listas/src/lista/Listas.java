...
/*
199.	* Obtiene el valor de un nodo en una determinada posición.
200.	* @param posicion del nodo que se desea obtener su valor.
201.	* @return un numero entero entre [0,n-1] n = numero de nodos de la lista.
...
/**
399.	* Mustra en pantalla los elementos de la lista.
400.	*/
public void listar(){
